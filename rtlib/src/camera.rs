...
impl Camera {
    ...
    pub fn new(
        ...
        let v = w.cross(&u);
        let llc =
            orig - half_width * focus_dist * u - half_height * focus_dist * v - focus_dist * w;
    ...
    pub fn get_ray(&self, s: f64, t: f64) -> Ray {
        ...
        ray!(
            ...
            &(self.lower_left_corner + self.horizontal * s + self.vertical * t
                - self.origin
                - offset), // changed the mult order so it didn't try to dereference self
            time
        )
    }
}
...
mod test {
    ...
    fn test_camera_new() {
        ...
        assert_eq!(c.origin, crate::vec3::Vec3::new(1.0, 1.0, 1.0));
    }
    ...
    fn test_get_ray() {
        ...
        let ans = ray!(
            &vect!(1.6712465080623153, 1.3039624788267186, 1.0),
