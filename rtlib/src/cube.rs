use crate::{
    ...
    hitlist::HitList,
    hittable::{FlipNormal, HitRecord, Hittable, Hitters},
...
mod test {
    ...
    fn test_cube_construction() {
        let p0 = vect!(-1, -1, -1);
        let p1 = vect!(1, 1, 1);
        let c0 = Cube::new(&p0, &p1, &MaterialType::default());
    ...
    fn test_cube_hit() {
        ...
        // from the front
        let r = Ray::new(&vect!(0, 0, 2), &vect!(0, 0, -1), None);
        ...
        // from the right side
        let r = Ray::new(&vect!(2, 0, 0), &vect!(-1, 0, 0), None);
        ...
        // from the top
        let r = Ray::new(&vect!(0, 2, 0), &vect!(0, -1, 0), None);
